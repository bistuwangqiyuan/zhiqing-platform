...
export default function CaseDetail({ params }: Params) {
  const c = CASES.find((x) => x.id === params.id);
  ...
  return (
    <>
      <section className="pt-28 pb-8">
        <div className="container">
          <Link href="/cases" className="inline-flex items-center gap-1 text-[13px] text-ink-500 hover:text-ink-700">
            <ArrowLeft className="h-3.5 w-3.5" /> 返回案例
          </Link>
          <Reveal>
      ...
      <section className="section bg-ink-50/40">
        <div className="container">
          <Reveal>
            <p className="text-[12px] tracking-[0.18em] uppercase text-ink-500">Next Case</p>
